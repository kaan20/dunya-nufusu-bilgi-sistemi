					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						<table class="table table-hover">
						  ...
						  <tbody>
							<?php
							$q = @mysqli_query($baglan, "SELECT * FROM kullanicilar ");
							...
							<tr>
								...
								<td>
									<a href="admin-kullanici-duzenle.php?id=<?php echo $row['id']?>" title="Düzenle"><i class="fa fa-edit btn btn-default btn-xm"></i></a>
									
								</td>
								
								<td>
									
									<a href="admin-kullanici-sil.php?id=<?php echo $row['id']?>" title="Sil"><i class="fa fa-close btn btn-default btn-xm red"></i></a>
								</td>
