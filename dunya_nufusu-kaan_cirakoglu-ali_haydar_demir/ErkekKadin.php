...
<body>
    ...
    <section id="menu">
        <div id="logo">Kadin ve Erkek Ölüm Oranlari</div>
        <?php 
		navbar();
		?>
    </section>
    ...
    <section id="solmenu">
        ...
        <main>
            <h1>Kadin ve Erkek Ölüm Oranlari</h1>
			<p>
			...
			new Chart("myChart", {
			  ...
			  data: {
				...
				datasets: [{ 
				  ...
				  "JOIN olum o ON k.id = o.kita_id WHERE cinsiyet = '1' ");
				  $count = mysqli_num_rows($q);
				  $say = 1;
				  while($row = mysqli_fetch_assoc($q)){
					echo $row['deger'];
				  ...
				  data: [<?php
				  $q = mysqli_query($baglan, "SELECT o.* FROM kitalar k ".
				  "JOIN olum o ON k.id = o.kita_id WHERE cinsiyet = '2' ");
				  $count = mysqli_num_rows($q);
				  $say = 1;
				  while($row = mysqli_fetch_assoc($q)){
					echo $row['deger'];
